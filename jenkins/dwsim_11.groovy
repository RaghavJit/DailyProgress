            ...
            steps { 
                script { 
                    ...
                    if (!commitMsg.toLowerCase().contains("build clean")) {
                        ...
                        sh '''
                            mv /var/lib/jenkins/site_directories/dwsim_uploads /var/lib/jenkins/site_directories/dwsim_uploads.${BUILD_NUMBER}
                            mv /var/lib/jenkins/site_directories/dwsim_public /var/lib/jenkins/site_directories/dwsim_public.${BUILD_NUMBER}
                            mkdir -p /var/lib/jenkins/site_directories/dwsim_uploads
                            mkdir -p /var/lib/jenkins/site_directories/dwsim_public
                        '''
                    }
                }
            }
